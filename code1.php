...
<?php
 ...
 {
 echo '<div class="card" >';
 echo '<img class="card-img-top" src="image\\'.$rows['MenuItemID'].'.jpg"
height="100px" width="100px" alt="'.$rows['ItemName'].'">';
echo '<div class="card-body">';
 echo '<p class="card-text">'.$rows['ItemName'].'</p>';
 echo '<p class="card-text">Rs.'.$rows['Price'].'</p>';
 $key=$rows["MenuItemID"];
 echo "<a href='AddToCart.php?ItemID=$key'><button type='button'
